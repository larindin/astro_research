...
initial_covariance = scipy.linalg.block_diag(initial_state_covariance, np.eye(6)*1e0**2)
...
num_particles = 500
first_magnitude_sampling_range = (1.01, 1.5)
second_magnitude_sampling_range = (0.998, 1.002)