...
smoothed_estimates, smoothed_covariances = run_EKF_smoothing_MC(CR3BP_dynamics_equation_STM,
                                                                dynamics_function_args,
                                                                filter_time,
                                                                anterior_estimates,
                                                                posterior_estimates,
...
for run_index in range(num_runs):
    ...
    smooth_control_errors.append(smoothed_estimates[run_index][6:9] - truth_control[:, -horizon-1:])
    smooth_control_covariances.append(smoothed_covariances[run_index][6:9, 6:9])
...
smoothed_estimation_errors = compute_estimation_errors(truth_vals[:, -horizon-1:], smoothed_estimates, (0, 6))
smoothed_three_sigmas = compute_3sigmas(smoothed_covariances, (0, 6))
