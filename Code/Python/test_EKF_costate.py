...
process_noise_covariance = np.eye((12))*(0.15)**2
generator_seed = 0
...
time_vals = np.arange(0, 2.336224101773999760e+00-0.05, 0.001)
...
def EKF_measurement_equation(X, mu):
    ...
    measurement_jacobian = azimuth_elevation_jacobian_costate(X, mu)
